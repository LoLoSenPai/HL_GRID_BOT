...
export function ReactiveTerminalChart({
  ...
  return (
    <div className="relative overflow-hidden rounded-md">
      {chartReady ? (
        <TerminalChart config={activeConfig} candles={cachedCandles} />
      ) : (
...
function ChartLoadingPlaceholder({ asset, error }: { asset: MarketSymbol; error?: string }) {
  return (
    <div className="flex h-[440px] min-h-[320px] w-full items-center justify-center rounded-md border border-border/60 bg-[linear-gradient(rgba(255,255,255,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.045)_1px,transparent_1px)] bg-[size:80px_54px]">
